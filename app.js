...
const deedsArray = [
    ...
    'Today is take your pet to work day. (If your employer will not go for this, take your pet somewhere fun that it’s never been before). (If you don’t have a pet, find a rock outside to draw a face on and take your pet rock to work. Introduce it to everyone.) This DailyDeed driven by grass, something all pets agree is pretty cool.',
    'The next time you’re shopping in a store where the cashier must also bag purchases, you bag. This DailyDeed driven by plastic bags, please don’t use us.',
    'Look for a person in a group that others don’t always support like you think they should. Go out of your way to say thank you to at least one person in this group. This DailyDeed driven by Snoop Dog and Martha Stewart (BFF; nuff said).',
    ...
    'Tell family/friends fun messages that you say your pets, small children, or famous person wanted you to tell the family/friend. Keep this going for at least 10 minutes. This DailyDeed driven by pets and babies, no judgment since the beginning of time.',
    'If you have family/friends who tend to bring up bad memories even when the conversation starts off about a good memory (people with some very bad memories tend to do this a lot due to their trauma), be mindful and pull them back to the good memory. This DailyDeed driven by stories, we go where you drive us.',
    'Two day task: On day one, ask a loved one tell you of a favorite day. Ask questions and pay special attention to where the day occurred. Then find pictures that show or represent that special day for your loved one and make an art project or photo display for your loved one. This DailyDeed driven by school glue, for cool projects and for a satisfying peel-off after slathering all over your hands.',
    ...
    'If you have a loved one who tells you stories over and over again, it could be because they just need to tell you again (to remember, to learn, or just because). Next time, don’t lose patience; just listen to them. This DailyDeed driven by your friends and family, just listen to us.',
    'Read this Dolly Parton quote and live it: “You’re allowed your own beliefs and your own faith, but you don’t have to use it like a weapon when it could be a tool….Make the good grow.” People Magazine Dec.13, 2021 pages 58 & 59. This DailyDeed driven by Dolly’s Imagination Library, a program that mails free, high-quality books to children from ages birth-5, no matter their family’s income.',
    'Reach out to a foster care non-profit and see how you can help the foster parents. Give what you can afford (time if nothing else; they’d probably love someone to mow the lawn or run an errand). This DailyDeed driven by the Child Welfare Information Gateway (Protecting Children; Strengthening Families). https://www.childwelfare.gov/',
    'Let a loved one (maybe a child or someone with child-like wonder) decide your plans to do together for the day (or as much time as you can spare). This DailyDeed driven by Kentucky State Parks, visit us today.',
    'Let a loved one (maybe a child or someone with child-like wonder) decide the menu for a meal you cook together. This DailyDeed driven by Hamburger Helper, yum with hamburger or tofu-burgers.',
    'Attend a charity event (a fancy event or any event really, including a virtual event) and make whatever donation you can afford. This DailyDeed driven by confetti, throw us and celebrate today.',
    'Go shopping either online or in person at a store that donates to a cause. This DailyDeed driven by Goodwill, we are a cause.',
    'Donate donuts or pizzas to a public servant group of your choice. This DailyDeed driven by apples, a healthy option.',
    'Offer to do a chore for a younger or older person in your family or neighborhood. This DailyDeed driven by glass cleaners, you know some windows who want to be sprayed today.',
    ...
    'You know those store receipt surveys that we never fill out. Fill one out with all great scores AND positive comments. This DailyDeed driven by all customer service workers, give us praise please for our thankless job.',
    'Think of a time that someone did something nice for you, perhaps from years ago. Send that person a long note of gratitude. This DailyDeed driven by cats & dogs, the 1 & 2 of pets.',
    'Go onto social media and make 10 kind comments. This DailyDeed driven by the Consortium of Extinct Cliches. ( like “Be kind. Rewind.” and “They don’t gee-haw.”)',
    'Go onto social media and find one person who did something kind for you in the past (even years and years ago). Send that person a message (private or public) expressing how kind their actions were and how thankful you are. This DailyDeed driven by the schoolyard bully, who’s crying on the inside.'
];
